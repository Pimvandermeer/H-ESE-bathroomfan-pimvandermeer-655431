...
namespace Devconsole
{
    ...
    bool DCSsimulationSystemInputYN(const char questionText[]);
    ...
    /// Shows text, user can enter an double value.
    double DCSsimulationSystemInputDouble(const char text[], double min, double max);
